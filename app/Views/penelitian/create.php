    ...
    <div id="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Form  -->
                <form action="/dosen/penelitian/add" method="post" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="date" name="tgl_mulai" class="form-control" size="30" maxlength="50" placeholder="" value="<?= old('tgl_mulai'); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <a href="/dosen/penelitian" class="btn btn-danger"><i class="fa fa-arrow-circle-left fa-fw"></i> Kembali </a>
